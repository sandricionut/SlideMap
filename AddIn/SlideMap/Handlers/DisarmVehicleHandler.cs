...
{
    internal class DisarmVehicleHandler : Button
    {
        ...
        protected override void OnClick()
        {
            ...
            SendCommandResponse response = vehicleCommandService.SendFlightCommandToVehicle("disarm");
            if(response.CommandResults[0].CommandStatus== CommandStatus.CS_SUCCEEDED)
            {
                MessageBox.Show("Vehicle disarmed.");
