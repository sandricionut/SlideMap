...
{
    internal class ReturnHomeVehicleHandler : Button
    {
        ...
        protected override void OnClick()
        {
            ...
            SendCommandResponse response = vehicleCommandService.SendFlightCommandToVehicle("return_to_home");
            if(response.CommandResults[0].CommandStatus== CommandStatus.CS_SUCCEEDED)
            {
                MessageBox.Show("Vehicle will return home.");
