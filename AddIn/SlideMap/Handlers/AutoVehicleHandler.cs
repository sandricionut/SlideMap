...
{
    internal class AutoVehicleHandler : Button
    {
        ...
        protected override void OnClick()
        {
            ...
            SendCommandResponse response = vehicleCommandService.SendFlightCommandToVehicle("auto");
            if(response.CommandResults[0].CommandStatus== CommandStatus.CS_SUCCEEDED)
            {
                MessageBox.Show("The vehicle is in auto mode.");
