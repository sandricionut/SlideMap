...
{
    internal class LandVehicleHandler : Button
    {
        ...
        protected override void OnClick()
        {
            ...
            SendCommandResponse response = vehicleCommandService.SendFlightCommandToVehicle("land_command");
            if(response.CommandResults[0].CommandStatus== CommandStatus.CS_SUCCEEDED)
            {
                MessageBox.Show("The vehicle is set to land.");
