...
{
    internal class HoldVehicleHandler : Button
    {
        ...
        protected override void OnClick()
        {
            ...
            SendCommandResponse response = vehicleCommandService.SendFlightCommandToVehicle("mission_pause");
            if(response.CommandResults[0].CommandStatus== CommandStatus.CS_SUCCEEDED)
            {
                MessageBox.Show("Vehicle will pause mission.");
